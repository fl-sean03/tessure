...
export const definition: SceneDefinition = {
  ...
  beats: [
    ...
    { id: 'respond', at: 34, title: 'A person makes the next check', body: 'In the authored response, the gate stays closed and a guard approaches the marked stopping point. The scheduled delivery has turned toward receiving; the second arrival waits outside.', evidence: [{ source: 'Gate state', detail: 'The arm remains lowered after the matched truck clears.' }, { source: 'Gate team', detail: 'A guard approaches from the protected walkway.' }] },
